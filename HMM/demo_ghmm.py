...
def train_GHMM(dataset):
    ...
    for label in dataset.keys():
        ...
        model = hmm.GaussianHMM(n_components=states_num,transmat_prior=transmatPrior, startprob_prior=startprobPrior, \
